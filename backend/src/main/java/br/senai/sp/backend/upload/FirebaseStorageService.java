package br.senai.sp.backend.upload;
...
public class FirebaseStorageService {
	...
	public void init() throws IOException {
		if(FirebaseApp.getApps().isEmpty()) {
			InputStream firebaseDataAuth = FirebaseStorageService.class.getResourceAsStream("/fypp-tcc-firebase-adminsdk.json");
			FirebaseOptions options = new FirebaseOptions.Builder()
					.setCredentials(GoogleCredentials.fromStream(firebaseDataAuth))
					.setStorageBucket("fypp-tcc.appspot.com")
					.setDatabaseUrl("https://fypp-tcc.firebaseio.com")
					.build();
